...
/** @class */
function () {
  function SvgInfo(width, height, svg) {
    var _this = this;
    ...
    this.mousedownHandler = function (event) {
      ...
      jquery_1.default(document).on('mousemove', _this.mousemoveHandler);
    };
    /**
     * 鼠标抬起事件处理函数
     */
    ...
    this.mouseupHandler = function () {
      jquery_1.default(document).off('mousemove');
    };

    this.mousemoveHandler = function (event) {
      var translateX = event.pageX - _this.startX;
      var translateY = event.pageY - _this.startY;

      var str = _this.svg.attr("viewBox");
  ...
  SvgInfo.prototype.updateSVG = function (type) {
    //放大
    if (type === 'magnify') {
    ...
    var width = this.width * this.scrollIndex * this.scrollPower;
    var height = this.height * this.scrollIndex * this.scrollPower;
    ...
    var w = (Number(this.svg.width()) + width).toFixed(6);
    var h = (Number(this.svg.height()) + height).toFixed(6);
    var scale = Number((Number(this.svg.width()) / Number(w)).toFixed(2));
    this.setScale(scale);
  ...
  SvgInfo.prototype.bindMousewheel = function () {
    var _this = this; //DOMMouseScroll


    this.svg.on('mousewheel', function (event) {
      if (event.originalEvent != null) {
        if (event.originalEvent.wheelDelta > 0) {
          _this.updateSVG("shrink");
        } else {
          //放大
          _this.updateSVG("magnify");
        }
      }
    });
  };
  ...
  SvgInfo.prototype.bindMouseup = function () {
    jquery_1.default(document).on('mouseup', this.mouseupHandler);
  };
  /**
   * 在图形区绑定绑定鼠标按下事件
   */
  ...
  SvgInfo.prototype.bindMousedown = function () {
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"src/utils/utils.ts":[function(require,module,exports) {
"use strict";
...
exports.createSingleTips = createSingleTips;
/**
 *
 * @param vdom
 * return domStr
...
exports.createElementByVdom = createElementByVdom;

function createElemTextByVdom(vdom) {
  var strDom = '';
...
function deepKeyValue(nodes) {
  ...
  var tag = nodes.nodeName;
  obj.tag = tag;
  var props = nodes.getAttributeNames();
  ...
  for (var i = 0; i < child.length; i++) {
    if (child[i].nodeType === 1 && exports.svgType.indexOf(child[i].nodeName) > -1) {
...
},{}],"src/utils/checkXML.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/utils/createSVG.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/js/singleTip.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.singleTip = void 0;
...
exports.singleTip = utils_1.createSingleTips();
},{"../utils/utils":"src/utils/utils.ts"}],"src/config.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/js/editArea.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function EditArea(edit) {
    ...
    this.bindInputChange = function () {
      _this.edit.on('input', _this.inputChangeHandler);
    };

    this.inputChangeHandler = function (event) {
      if (event.target) {
        _this.editText = event.target.innerText.trim();
        _this.editHtml = event.target.innerHTML;
      }

      if (_this.editText.length == 0) return;
      ...
      while (ret) {
        ...
        if (config_1.singleTag.indexOf(retMatch[0]) !== -1) {
          inputSingleTag.add(retMatch[0]);
        } else if (config_1.doubleTag.indexOf(retMatch[0]) !== -1) {
...
},{"jquery":"node_modules/jquery/dist/jquery.js","../utils/utils":"src/utils/utils.ts","../utils/checkXML":"src/utils/checkXML.ts","../utils/createSVG":"src/utils/createSVG.ts","./singleTip":"src/js/singleTip.ts","../index":"src/index.ts","../config":"src/config.ts"}],"src/js/domTree.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function DomTree(domView) {
    ...
    this.domViewClickHandler = function () {
    ...
    this.showWrapClickHandler = function (event) {
      ...
      if (selMark[0]) {
        ...
        var svg = jquery_1.default("#graph-svg");
        var currentRect = selMark.get(0).getBoundingClientRect();
        var percentRect = svg.get(0).getBoundingClientRect();
        var x = void 0,
            y = void 0,
            setX = void 0,
            setY = void 0,
        ...
        var rectTip = jquery_1.default("#rect-tip");
        rectTip.attr({
      ...
      _this.prev = target;
      _this.selectDomFlag = target.hasClass("select-dom");
      var oMenu = jquery_1.default("#menu");
...
},{"jquery":"node_modules/jquery/dist/jquery.js","../config":"src/config.ts","../index":"src/index.ts","../utils/utils":"src/utils/utils.ts"}],"src/js/selMenu.ts":[function(require,module,exports) {
"use strict";
...
},{"jquery":"node_modules/jquery/dist/jquery.js","./singleTip":"src/js/singleTip.ts","../utils/utils":"src/utils/utils.ts","../index":"src/index.ts"}],"src/js/attrArea.ts":[function(require,module,exports) {
"use strict";
...
exports.default = AttrArea;
},{"jquery":"node_modules/jquery/dist/jquery.js","../config":"src/config.ts","./singleTip":"src/js/singleTip.ts"}],"src/js/addBtn.ts":[function(require,module,exports) {
"use strict";
...
},{"jquery":"node_modules/jquery/dist/jquery.js","./singleTip":"src/js/singleTip.ts","../config":"src/config.ts","../utils/utils":"src/utils/utils.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var svgInfo_1 = __importDefault(require("./js/svgInfo"));
